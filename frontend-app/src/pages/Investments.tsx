...
export const Investments: React.FC = () => {
  ...
  return <div>
    <div className="mb-3 flex items-center justify-end"><span className="inline-flex items-center rounded-full border border-[#e3ebe8] bg-white px-3 py-1.5 text-[11px] font-extrabold text-[#71808c] shadow-sm"><span className="mr-1.5 h-1.5 w-1.5 animate-pulse rounded-full bg-[#087f74]" />Next refresh in <span className="ml-1 text-[#087f74]">{secondsToRefresh}s</span></span></div>
